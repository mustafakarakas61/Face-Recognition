...
from Environments import pathTempFolder, pathClippedVideos
from utils.Utils import checkFolder, getMp4FileList


# {"name":"Recep Tayyip Erdoğan","url":"https://www.youtube.com/watch?v=fxUox86xQGc&t=7s","ss":"00:00:30","to":"00:00:45"}
def createClippedVideo(url, ss, to, name):
    ...
    cmd = f"ffmpeg -y -loglevel fatal -ss {ss} -i \"{pathTempFolder}temp_{fileName}\" -to {to} -c copy \"{pathName}/{fileName}\""
