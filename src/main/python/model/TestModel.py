...
from src.resources.Environments import pathModels, pathFaceCascade, inputSize, successRate, pathTest, pathFaceResultsMap, \
    minTestFaceSize
...
if len(faces) == 0:
    ...
    for (x, y, w, h) in faces:
        ...
        # faceImage = cv2.cvtColor(faceImage, cv2.COLOR_BGR2GRAY)  # girdi 1 boyutlu ise
